...
{
    /// <summary>
    /// Circuit-breaker logic that is hooked into <see cref="HystrixCommand{TResult}"/> execution and will stop allowing executions if failures have gone past the defined threshold.
    /// <para>
    ...
    public interface IHystrixCircuitBreaker
    {
        ...
        /// <summary>
        /// Every <see cref="HystrixCommand{TResult}"/> request asks this if it is allowed to proceed or not.  It is idempotent and does
